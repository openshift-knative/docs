...
IMPORTANT: In order to experience the full functionality of Knative Eventing on Openshift you must add the `knative-eventing` namespace to the `ServiceMeshMemberRole` object, located in the `knative-serving-ingress` namespace.
