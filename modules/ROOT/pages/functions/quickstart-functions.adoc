...
* For more information about optional flags that can be set when creating a {short-name} project, see xref:../functions/functions-cli.adoc[CLI options].
* For information about using functions as part of an event-driven workflow, see xref:../functions/concepts/event-workflows.adoc[Event workflows].
