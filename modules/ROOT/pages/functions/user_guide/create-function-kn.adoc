...
You can create a function by using the `kn func init` command.

.Example command
[source,terminal]
----
$ kn func init <path> -r <registry> -l <runtime> -t <trigger> -i <image> -n <namespace> -c
----
...
[source,terminal]
----
$ kn func init <path> -r <registry> -l <runtime> -t <trigger> -i <image> -n <namespace>
----
+
...
[source,terminal]
----
$ kn func init functions/fn.example.io
----
+
.Example output
[source,terminal]
