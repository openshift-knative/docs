...
**** xref:serverless-logic:core/defining-an-input-schema-for-workflows.adoc[Input schema definition]
**** xref:serverless-logic:core/custom-functions-support.adoc[Custom functions for your workflow service]
**** xref:serverless-logic:core/timeouts-support.adoc[Timeouts Support]
...
**** xref:serverless-logic:tooling/serverless-logic-web-tools/serverless-logic-web-tools-overview.adoc[KIE Serverless Workflow Editor]
...
***** xref:serverless-logic:tooling/serverless-logic-web-tools/serverless-logic-web-tools-redhat-application-services-integration.adoc[Integration with Service Registries]
...
***** xref:serverless-logic:security/authention-support-for-openapi-services.adoc[OpenAPI Authentication]
***** xref:serverless-logic:security/orchestrating-third-party-services-with-oauth2.adoc[OpenAPI OAuth2]
...
**** Quarkus
***** xref:serverless-logic:testing-and-troubleshooting/mocking-http-cloudevents-with-wiremock.adoc[Mocking HTTP CloudEvents]
***** xref:serverless-logic:testing-and-troubleshooting/mocking-openapi-services-with-wiremock.adoc[Mocking OpenAPI Services]
***** xref:serverless-logic:testing-and-troubleshooting/basic-integration-tests-with-restassured.adoc[Testing with REST Assured]
...
***** xref:serverless-logic:cloud/quarkus/deploying-on-openshift.adoc[Deploying Workflows on OpenShift]
...
*** Integrations
**** xref:serverless-logic:integrations/camel-routes-integration.adoc[Camel Routes]
**** xref:serverless-logic:integrations/custom-functions-knative.adoc[Knative Serving]
**** xref:serverless-logic:integrations/expose-metrics-to-prometheus.adoc[Exposing Prometheus Metrics]
...
**** xref:serverless-logic:job-services/quarkus-extensions.adoc[Quarkus Extensions]

*** Data Index
**** xref:serverless-logic:data-index/data-index-core-concepts.adoc[Core concepts]
**** xref:serverless-logic:data-index/data-index-service.adoc[Standalone service]
**** xref:serverless-logic:data-index/data-index-quarkus-extension.adoc[Quarkus Extension]

*** Use Cases
**** xref:serverless-logic:use-cases/orchestration-based-saga-pattern.adoc[Saga Orchestration]
**** xref:serverless-logic:use-cases/timeout-showcase-example.adoc[Timeouts Showcase]
