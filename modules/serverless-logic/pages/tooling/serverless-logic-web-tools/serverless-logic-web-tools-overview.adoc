...
[IMPORTANT]
====
 {serverless_logic_web_tools_name} is Development Support Scope only. For more information about the support scope of Red Hat Development Support see https://access.redhat.com/solutions/7031210.
====
