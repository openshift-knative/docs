...
+
--
.. Download and extract the `chrome_extension_serverless_workflow_editor_VERSION.zip` file from the link:{kn_workflow_plugin_releases_url}[kie-tools] releases page in GitHub.
