...
For more information about the tooling and the required dependencies, see xref:serverless-logic:getting-started/getting-familiar-with-our-tooling.adoc[Getting familiar with {context} tooling].
...
For more information about Knative workflow CLI, see xref:serverless-logic:tooling/kn-plugin-workflow-overview.adoc[{context} plug-in for Knative CLI].
--
====
...
Also, to deploy and run your workflow application, see xref:serverless-logic:cloud/deploying-on-minikube.adoc[Deploying workflow application on Minikube]
--
====
+
.Example response
