...
* Required tooling is installed. For more information, see {getting-familiar-with-our-tooling}[Getting familiar with {context} tooling].
...
You can test your workflow application using the instructions described in xref:serverless-logic:testing-and-troubleshooting/basic-integration-tests-with-restassured.adoc[Testing your workflow application using REST Assured] document. 
