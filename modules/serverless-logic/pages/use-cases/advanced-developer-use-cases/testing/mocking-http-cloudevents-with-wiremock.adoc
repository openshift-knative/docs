...
:mocking_openapi_services_with_wiremock_guide: xref:use-cases/advanced-developer-use-cases/testing/mocking-openapi-services-with-wiremock.adoc
...
:consume-produce-events-with-knative-eventing_guide: xref:use-cases/advanced-developer-use-cases/event-orchestration/consume-produce-events-with-knative-eventing.adoc
:mocking_http_cloudevents_with_wiremock_test_class: xref:use-cases/advanced-developer-use-cases/testing/mocking-http-cloudevents-with-wiremock.adoc#ref-create_test_class
// External pages
