...
* To adjust the provisioned image, use `quarkus.kogito.devservices.imageName={kogito_devservices_imagename}` property.
...
|`{kogito_devservices_imagename}:{page-component-version}`
|No
