...
:current_operator_version: 1.38.1
:next_operator_version: 1.39.0
:next_swf_builder_image: registry.redhat.io/openshift-serverless-1/logic-swf-builder-rhel9:1.39.0

= Upgrade {operator_name} from {current_operator_version} to {next_operator_version}
:compat-mode!:
// Metadata:
:description: Upgrade OSL Operator from 1.38.1 to 1.39.0
