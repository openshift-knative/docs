...
This guide describes how to install the {operator_name} in a Kubernetes or OpenShift cluster. The operator  has been tested on OpenShift {openshift_version_min}+ and link:{minikube_url}[Minikube].
