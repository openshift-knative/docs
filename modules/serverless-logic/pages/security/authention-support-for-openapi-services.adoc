= Authentication for OpenAPI services in {product_name}
:compat-mode!:
// Metadata:
...
* {orchestrating-third-party-services-with-oauth2}[Orchestration of third-party services using OAuth 2.0 authentication in {product_name}]
