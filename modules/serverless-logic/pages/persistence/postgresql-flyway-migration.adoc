...
----
--
* Download the { product_name } DDL zip from link:{kogito_ddl_script_url}[this link], choose the correct version,  extract the files and use the scripts from the `postgresql` folder.
...
* You can find the { product_name } DDL scripts by visiting link:{kogito_ddl_script_url}[this link].
* Download the zip file of the scripts from the needed version for the { product_name } upgrade.
* Extract the files.
